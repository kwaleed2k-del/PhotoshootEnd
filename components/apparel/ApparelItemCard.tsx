...
import { Trash2, Loader2, ChevronDown, Plus, Camera, Sparkles } from 'lucide-react';
...
export const ApparelItemCard: React.FC<{ 
    ...
    const { updateApparelItemView } = useStudio();
    ...
    return (
        <div className="p-3 bg-zinc-850 rounded-lg flex flex-col gap-3 border border-white/5 hover:border-white/10 hover:bg-zinc-800 transition-all duration-200 shadow-inner-soft">
            <div className="flex items-start gap-4">
                <img src={item.base64} alt="Apparel preview" className="w-16 h-16 object-cover rounded-md border border-white/10" />
                                ...
                                <div className="relative" ref={dropdownRef}>
                                    ...
                                    >
                                        {item.category !== 'Uncategorized' && (
                                            <Sparkles size={10} className="text-violet-400" title="AI detected" />
                                        )}
